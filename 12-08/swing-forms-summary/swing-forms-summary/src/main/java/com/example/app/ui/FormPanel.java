...
public class FormPanel extends JPanel {
    ...
    private void trySubmit() {
        ...
        if (!Validation.notBlank(name)) {
            JOptionPane.showMessageDialog(this,
                    "Preencha o campo Nome.",
                    "Campo nome incorreto", JOptionPane.WARNING_MESSAGE);
            return;
        } else if (!Validation.isEmail(email)) {
            JOptionPane.showMessageDialog(this,
                    "Preencha o campo E-mail com um e-mail válido.",
                    "Campo e-mail incorreto", JOptionPane.WARNING_MESSAGE);
            return;
        } else if (!Validation.notBlank(body)) {
            JOptionPane.showMessageDialog(this,
                    "Preencha o campo Mensagem com uma mensagem válida.",
                    "Campo mensagem incorreto", JOptionPane.WARNING_MESSAGE);
            return;
        }
